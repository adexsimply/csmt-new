              ...
              <div class="os-tabs-w">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="firstTerm{{$x+1}}">
                   <a href="{{App\Assessment::printUrl($student_id,$value->aagc_id,$value->session_id,$main_position,5,1,$cummulative)}}">Print</a>
                     @if($subjects)
                  ...
                  <div class="tab-pane" id="secondTerm{{$x+1}}">
                   <a href="{{App\Assessment::printUrl($student_id,$value->aagc_id,$value->session_id,$main_position,5,2,$cummulative)}}">Print</a>
                    @if($subjects)
                  ...
                  <div class="tab-pane" id="thirdTerm{{$x+1}}">
                   <a href="{{App\Assessment::printUrl($student_id,$value->aagc_id,$value->session_id,$main_position,5,3,$cummulative)}}">Print</a>
                    @if($subjects)
