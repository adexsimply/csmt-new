...
<div class="element-box">
      ...
      <form method="post" enctype="MULTIPART/FORM-DATA" onsubmit="oisForm(event)" action="{{url('old-testimonials/update')}}">
        ...
        <div class="form-group">
          ...
          <input type="text" name="admission_no" class="form-control" value="{{$testimonial->admission_no}}" />
        </div>
