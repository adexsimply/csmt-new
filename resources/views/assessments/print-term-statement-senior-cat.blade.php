    ...
    <body>
      ...
      <div class=""></div>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr>
                <td>Punctuality</td><td>Classroom:&nbsp;{{App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student_id))}}
              ...
              <tr>
                ...
                {{App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student_id))}}
               </td>
              </tr>
              <tr>
                <td>Carrying out Assignments</td><td>Classroom:&nbsp;{{App\Assessment::remark(App\Assessment::sAssigment($aagc_id,$session_id,$term_id,$student_id))}}<!-- <div><div id="span1" class="t">Hostel:&nbsp;{{App\Assessment::remark(App\Assessment::hAssigment($aagc_id,$session_id,$term_id,$student_id))}}
                                         </div></div> --></td>
              </tr>
              <tr>
