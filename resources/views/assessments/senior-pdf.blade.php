              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                    ...
                    @foreach($subjects as $subject)
                      ...
                      <tr>
                          ...
                          <td class="blue-subj" style="padding-left:3%;">{{$score['gp']}}</td>
                          <td class="blue-subj" style="padding-left:2%;"><strong class="blue-st">{{$score['grade']}}</strong></td>
                          <td class="blue-subj"><strong class="blue-st">{{$score['remark']}}</strong></td>
