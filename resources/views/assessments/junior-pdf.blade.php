...
@foreach($students as $x => $student)
    ...
    <body>
                         ...
                         @foreach($subjects as $subject)
                            ...
                            @if(App\Subject::categoryId($subject->id)->subject_category_id == $Category->id)
                              <tr>
                                  ...
                                  <td style=" text-align:center;font-size:12px;">{{!is_null($score['scores']['test3']) ? $score['scores']['test3'] : '-' }}</td>
                                  <td style=" text-align:center;font-size:12px;">{{!is_null($score['scores']['micro_exam']) ? $score['scores']['micro_exam'] : '-'}}</td>
                                  <td style=" text-align:center;font-size:12px;">{{$exam}}</td>
                                  <td style="text-align:center;font-size:12px;"><strong class="blue-st">{{$score['gp']}}</strong></td>
                                  <td class="blue-subj" style="font-size:12px;">{{$score['grade']}}</td>
                                  <td style="font-size:12px;"><strong class="blue-st">{{$score['remark']}}</strong></td>
                              </tr>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr style="height: 50px;">
                <td style="padding-top: 10px">Punctuality</td><td style="padding-top: 10px">Classroom:&nbsp;{{App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student->id))}}
              ...
              <tr style="height: 30px;">
                ...
                {{App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student->id))}}</td>
              </tr>
      ...
      <div style="width:66%;font-size:20px;float:left;margin-top:-15px;"> 
        ...
        <p>Comment by Form Teacher: <span class="blue-com">{{$aagc_info->teacher_comment ? $aagc_info->teacher_comment : 'NO COMMENT YET' }}</span><br/>
          <?php 
          if ($student->student_category_id ==1) {?>
        Comment by Hostel Parent: <span class="blue-com">{{$aagc_info->hostel_comment ? $aagc_info->hostel_comment : 'NO COMMENT YET' }}</span><br/>

        <?php } ?>
        Comment by Principal: <span class="blue-com">{{$aagc_info->principal_comment ? $aagc_info->principal_comment : 'NO COMMENT YET' }}</span></p>
