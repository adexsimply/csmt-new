...
<head>
  ...
  <link href="{{ asset('bower_components/bootstrap/bootstrap.css') }}" rel='stylesheet' type='text/css'>
  <style type="text/css">
    html, body {
      margin: 0;
      padding: 0;
        ...
        <tbody>
            <tr>
              ...
              <td><strong>Class:&nbsp;</strong><strong class="blue-st">
                      {!! App\Aagc::name($aagc_id) !!} {{App\Student::categoryName($category_id)}}</strong></td>
              <td><strong>Session:&nbsp;</strong>{{App\Session::find($session_id)->name}}<strong class="blue-st"></strong></td>
            </tr>
        </tbody>
      </table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    if ($subject_name=='AGRICULTURAL SCIENCE') {
                                     ...
                                     ?>
                                      <th style="max-width: 50px;">{{$subject_name}}</th>
                                    @endforeach
                                    <th>Total</th>
                                </tr>
                            </thead>
