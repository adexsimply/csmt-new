		...
		<div class="main">
			...
			<div class="panel panel-info" style="margin-top:-18px;line-height:1;">
				...
				<tr><th colspan="3">Percentage</th></tr>
					...
					<tbody>
				     <tr><td>{{round((App\Assessment::FAILCount($aagc_id,$session_id,$category_id,$term_id,$subject_id)*100)/App\Assessment::classCount($aagc_id,$session_id,$category_id,$term_id,$subject_id),2)}}%</td><td>{{round((App\Assessment::PASSCount($aagc_id,$session_id,$category_id,$term_id,$subject_id)*100)/App\Assessment::classCount($aagc_id,$session_id,$category_id,$term_id,$subject_id),2)}}%</td></tr>
					</tbody>
				</table>
				<table class="table table-bordered table-condensed table-responsive" style="width:49%;float:right; margin-top:2%;">
				<thead>
