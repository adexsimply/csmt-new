...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ config('app.name') }} Senior school result</title>
    ...
    <body>
                ...
                <table class="table table-bordered table-condensed" style="margin-top:-18px;">
                  <tbody>
                      <tr>
                        ...
                        {{App\Assessment::classCount2($aagc_id,$session_id,$student->student_category_id,3)}}
                        </strong></td>
                  ...
                  <!-- Grade head -->
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">    <thead>
                      <tr style="border-bottom:2px solid black;">
                        ...
                        ?>
                        <th style=" text-align:center" width="5%" class="blue-st">1st<br/>Test</th>
                        <th style=" text-align:center" width="5%" class="blue-st">2nd<br/>Test</th>
                        <th style=" text-align:center" width="5%" class="blue-st">3rd<br/>Test</th>
                        <th style=" text-align:center" width="5%" class="blue-st">CUM<br/>CAT</th>
                        <th style=" text-align:center" width="5%" class="blue-st">OBJ</th>
                        <th style=" text-align:center" width="5%" class="blue-st">Exam</th>
                        <th style=" text-align:center" width="5%" class="blue-st">Total<br/>Score</th>
                        <th style=" text-align:center" width="5%" class="blue-st">Grd.</th>
                        <th style="" class="blue-st" width="16%">Remarks</th>
                      </tr>
                      <tr style="border-bottom:2px solid black;">
                        <th width="1%" class="blue-st">S/N</th>
                        <th class="blue-st" colspan="2">Subject</th>
                        <th style=" text-align:center" class="blue-st">10</th>
                        <th style=" text-align:center" class="blue-st">10</th>
                        <th style=" text-align:center" class="blue-st">10</th>
                        <th style=" text-align:center" class="blue-st">15</th>
                        <th style=" text-align:center" class="blue-st">25</th>
                        <th style=" text-align:center" class="blue-st">60</th>
                    ...
                    <tbody class="input">
                      ...
                      <?php 
                      $x=1;
                      $subjects = App\Assessment::classSubjectStudent($aagc_id,$session_id,$term_id,$student->id); ?>
                    @foreach($subjects as $subject)
                      ...
                      <tr>
                          ...
                          <td style=" text-align:center;border: 1px solid black;">{{!is_null($score['scores']['test1']) ? $score['scores']['test1'] : '-'}}</td>
                          <td style=" text-align:center;border: 1px solid black;">{{!is_null($score['scores']['test2']) ? $score['scores']['test2'] : '-'}}</td>
                          <td style=" text-align:center;border: 1px solid black;">{{!is_null($score['scores']['test3']) ? $score['scores']['test3'] : '-'}}</td>
                          <td style=" text-align:center;border: 1px solid black;">{{round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)}}</td>
                          <td style=" text-align:center;border: 1px solid black;">{{!is_null($score['scores']['micro_exam']) ? $score['scores']['micro_exam'] : '-'}}</td>
                          <td style=" text-align:center;border: 1px solid black;">{{!is_null($score['scores']['exam']) ? $score['scores']['exam'] : '-'}}</td>
                          <td class="blue-subj" style="padding-left:3%;">{{round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam']}}</td>
                          <td class="blue-subj" style="padding-left:2%;"><strong class="blue-st">{{App\Assessment::grade(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam'])}}</strong></td>
                          <td class="blue-subj"><strong class="blue-st">{{App\Assessment::remark(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam'])}}</strong></td>

                      </tr>

                      <?php 
                            $total+= round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam'];
                            $x++; 
                      ?>
                    @endforeach
                    </tbody>
                  ...
                  <div class="panel-footer" style="font-size:13px; margin-top:1px; padding:5px; border:1px solid black;">
                    ...
                    &nbsp;<strong>Result:</strong> <strong class="blue-st">PASS</strong>&nbsp; &nbsp;@if (App\Term::find($term_id)->name=='THIRD TERM')<strong>Status: </strong> <strong class="blue-st">
      ...
      <div class=""></div>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr>
                <td>Punctuality</td><td>Classroom:&nbsp;{{App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student->id))}}
                                         <div><div id="span1" class="t">Resumption:&nbsp;
                                         {{strtoupper(App\Assessment::rPunctuality($aagc_id,$session_id,$term_id,$student->id))}}</div></div></td>
              </tr>
              <tr>
                <td>Attendance</td><td>Classroom:&nbsp;
                {{App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student->id))}}
               </td>
              </tr>
              <tr>
                <td>Carrying out Assignments</td><td>Classroom:&nbsp;{{App\Assessment::remark(App\Assessment::sAssigment($aagc_id,$session_id,$term_id,$student->id))}}<!-- <div><div id="span1" class="t">Hostel:&nbsp;{{App\Assessment::remark(App\Assessment::hAssigment($aagc_id,$session_id,$term_id,$student->id))}}
                                         </div></div> --></td>
              </tr>
              <tr>
                <td>Others</td><td>Clinic:&nbsp; <?php if (App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student->id) >0) { echo App\Assessment::remark2((App\Assessment::clinicCount($aagc_id,$session_id,$term_id,$student->id)*100)/App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student->id)); } else { echo "NOT REGULAR"; } ?><div><div id="span1" class="t">Exeat:&nbsp; <?php if (App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student->id)>0) { echo App\Assessment::remark2((App\Assessment::exeatCount($aagc_id,$session_id,$term_id,$student->id)*100)/App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student->id)); } else { echo "NOT REGULAR"; } ?></div></div></td>
              </tr>
          </tbody>
        </table>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:right;">
          <tbody>
                 <?php
                  ...
                  ?>
              <tr>
                <td>Club Performance</td><td> {{$performance ? App\Assessment::remark($performance->performance) : '-'}}</td>
              </tr>
              <tr>
                <td>Project Theme</td><td>  {{$psychomotor ? $psychomotor->pet_project : '-'}}</td>
              </tr>
      ...
      <div style="width:66%;font-size:20px;float:left;margin-top:-15px;"> 
       <?php $comments = App\Assessment::comments($aagc_id,$session_id,$term_id,$student->id,$student->student_category_id); ?>
