<div class="col-xs-12">
	@if($permissions)
		<form onsubmit="oisForm(event)" method="POST" action="{{route('roles.update',$role->id)}}">
			...
			<div class="form-group">
				...
				<input type="text" value="{{ucwords($role->name)}}" required="" name="name" placeholder="Enter role name" class="form-control" />
				@if ($errors->has('name'))
