                          ...
                          <div class="col-sm-5 col-xxl-4">
                            <div class="tablos">
                              <div class="row mb-xl-2 mb-xxl-3">
                                ...
                                <div class="col-sm-6">
                                  <a class="element-box el-tablo centered trend-in-corner padded bold-label" href="{{url('students/birthday')}}" data-size="xl" data-type="purple" data-title="Birthday" onclick="oisRead(event)">
                                    <div class="value">
                                      {{App\Student::birthday(true)}}
                                    </div>
                                    <div class="label">
                                      Birthday
                                    </div>
                                ...
                                <div class="col-sm-6">
                                  <a class="element-box el-tablo centered trend-in-corner padded bold-label" href="{{url('students')}}">
                                    <div class="value">
                                      {{App\Student::where('status',1)->count('id')}}
                                    </div>
                                    <div class="label">
                                      Active students
                                    </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <a class="element-box el-tablo centered trend-in-corner padded bold-label" href="{{url('students/1/1')}}">
                                    <div class="value">
                                      {{App\Student::where([['student_category_id',1],['status',1]])->count()}}
                                    </div>
                                    <div class="label">
                                      Boarding Students
                                    </div>
                                ...
                                <div class="col-sm-6">
                                  <a class="element-box el-tablo centered trend-in-corner padded bold-label" href="{{url('students/1/2')}}">
                                    <div class="value">
                                      {{App\Student::where([['student_category_id',2],['status',1]])->count()}}
                                    </div>
                                    <div class="label">
                                      Day students
                                    </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-12">
                                  <a class="element-box el-tablo centered trend-in-corner padded bold-label" href="{{url('students/3')}}">
                                    <div class="value">
                                      {{App\Student::where('status',3)->count()}}
                                    </div>
                                    <div class="label">
                                      Graduated Students
                                    </div>
    ...
    <div class="modal-dialog modal-sm ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form onsubmit="oisForm(event)" method="POST" action="{{url('classes/aagc/store')}}">
            {{csrf_field()}}
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      /*Admission history*/
      jQuery.getJSON("{{url('students/admission-graph')}}").done(function(data){
    ...
    /*Student bar chart*/
    jQuery.getJSON("{{url('students/class-student-graph')}}").done(function(data){
      console.log(data);
      var graphData = new Array();
        var label = new Array();
        $.each(data.data,function(i,value){
