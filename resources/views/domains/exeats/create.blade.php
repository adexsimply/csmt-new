<div class="col-sm-12">
	@if($students)
		...
		<input data-type="purple" data-title="Previously marked" data-size="xl" type="date" data-url="{{url('exeat/show/'.$aagc_id.'/'.$session_id.'/'.$term_id.'/'.$category_id)}}" onchange="viewAttendance(event)" class="form-control" />
		<hr />

		<h3>Mark new </h3>

		<form method="post" onsubmit="oisForm(event)" action="{{url('exeat/store')}}">
