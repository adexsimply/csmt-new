<div class="col-sm-12">
			<input  name="aagc_id" value="{{$aagc_id}}">
			<input  name="session_id" value="{{$session_id}}">
			<input  name="term_id" value="{{$term_id}}">
			<input  name="subject_id" value="{{$subject_id}}">
	@if($attendances)
		
		<form method="post" onsubmit="oisForm(event)" action="{{url('assignment/subject/update')}}">
