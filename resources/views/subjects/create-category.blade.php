...
@section('content')
  ...
  <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <span>Add subjects to category</span>
            </li>
          </ul>
          <!--
          END - Breadcrumbs
                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                      ...
                      @if(count($subjects) > 0)
                        ...
                        <form class="mt-4" method="POST" action="{{url('subjects/category/store')}}">
                          ...
                          <div class="form-group">
                            ...
                            <input required="" class="form-control" name="name" placeholder="Enter subject name" type="text">
                          </div> 
                           ...
                           <div class="table-responsive">
                             ...
                             <div class="form-buttons-w">
                              <button class="btn btn-primary" type="submit"> Create Subject category</button>
                            </div>
                       </form>
