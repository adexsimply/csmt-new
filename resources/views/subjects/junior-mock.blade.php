                                ...
                                @foreach($students as $student)
                                  ...
                                  <tr>
                                      ...
                                      @endforeach
                                        ...
                                        <td>
                                          <a class="viewJuniorMock" target="_blank" href="{{url('junior-mock/show/'.$student->id)}}"><i class="fa fa-print"></i></a>

                                          <a class="editJuniorMock" href="{{url('junior-mock/edit/'.$student->id.'/'.$session->id)}}"><i class="fa fa-edit"></i></a>
                                        </td>
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(".editJuniorMock").click(function(e){
          e.preventDefault();
          url = $(this).attr('href');
          dialog(url,'Update Junior Mock score','m');
      });
