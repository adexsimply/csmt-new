                                ...
                                @foreach($students as $student)
                                  ...
                                  <tr>
                                      ...
                                      @foreach($subjects as $subject)
                                          ...
                                          <?php
                                              $score = App\Waec::score($student->id, $subject->id);
                                              if($score)
                                                $score = $score->score;
                                              else
                                                $score = 0;
                                      ...
                                      @endforeach
                                        ...
                                        <td>
                                          <a class="viewWaec" target="_blank" href="{{url('waec/show/'.$student->id)}}"><i class="fa fa-print"></i></a>

                                          <a class="editWaec" href="{{url('waec/edit/'.$student->id.'/'.$session->id)}}"><i class="fa fa-edit"></i></a>
                                        </td>
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(".editWaec").click(function(e){
          e.preventDefault();
          url = $(this).attr('href');
          dialog(url,'Update Waec score','m');
      });
