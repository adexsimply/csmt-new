	...
	<div class="page" style="padding:35px;">
		<div class="main-top">
			...
			<img src="{{ asset('storage/images/logo-lg.jpg') }}" width="300px">
				...
				<div class="sor" style="border:2px solid blue;color:blue; font-size:30px; font-weight:bold; width:auto;margin-left:30px;margin-top:5px;font-family:Tempus Sans ITC">STATEMENT OF RESULT</div>
			</div>
		</div>
		<div class="main">
				...
				<tbody>
					<tr>
						...
						<td class="input" style="padding:3px;">
							<strong>Examination&nbsp;No:</strong>&nbsp;<strong class="blue-st">{{$student->bece_details->examination_no}}</strong>
						</td>
			        ...
			        <tbody class="input">
			        	<?php $credits = 0; $passes=0; $x=1; ?>
			         	@foreach($subjects as $subject)
			         		<?php $score = App\Bece::score($student->id,$subject->id)->score; ?>
			         		<tr>
					            <th style="">{{$x}}</th>
			...
			<div class=""></div>
					...
					<div style="width:66%;font-size:20px;float:left;margin-top:5px;">					
						<p>Remarks: <span class="blue-com">{{$student->bece_details->remark}}</span><br/>
