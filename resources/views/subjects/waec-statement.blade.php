	...
	<div class="page" style="padding:35px;">
		<div class="main-top">
			...
			<img src="{{ asset('storage/images/logo-lg.jpg') }}" width="300px">
				...
				<div class="sor" style="border:2px solid blue;color:blue; font-size:30px; font-weight:bold; width:auto;margin-left:50px;margin-top:5px;font-family:Tempus Sans ITC">STATEMENT OF RESULT</div>
			</div>
		</div>
		<div class="main">
				...
				<tbody>
					<tr>
						...
						<td class="input" style="padding:3px;">
							<strong>Examination&nbsp;No:</strong>&nbsp;<strong class="blue-st">{{$student->waec_details->examination_no}}</strong>
						</td>
			        ...
			        <tbody class="input">
			        	<?php $credits = 0; $passes=0; $x=1; ?>
			         	@foreach($subjects as $subject)
			         		<?php $score = App\Waec::score($student->id,$subject->id)->score; ?>
			         		<tr>
					            <th style="">{{$x}}</th>
					            <td class="blue-subj">{{$subject->name}}</td>
					            <td class="blue-subj" style="padding-left:3%;" >{{$score}}</strong></td>
					            <td><?php 
					            if($score=="A" || $score=="B") {
			...
			<div class=""></div>
				<div class="panel-heading" style=""><h4 style="margin:0;">*** I Certify that this is a true copy of the result of the above mentioned Examination Council.</h4> <h4>Any erasure renders it invalid</p></h4></div>
			<div class=""></div>
				
					<div style="width:66%;font-size:20px;float:left;margin-top:5px;">					
						<p>Remarks: <span class="blue-com">{{$student->waec_details->remark}}</span><br/>
