                                ...
                                @foreach($students as $student)
                                  ...
                                  <tr>
                                      ...
                                      @endforeach
                                        ...
                                        <td>
                                          <a class="viewBece" target="_blank" href="{{url('bece/show/'.$student->id)}}"><i class="fa fa-print"></i></a>

                                          <a class="editBece" href="{{url('bece/edit/'.$student->id.'/'.$session->id)}}">
...
@section('script')
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(".editBece").click(function(e){
          e.preventDefault();
          url = $(this).attr('href');
          dialog(url,'Update Bece score','m','purple');
      });
