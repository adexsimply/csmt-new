...
<div class="element-box">
	<form onsubmit="oisForm(event)" method="post" action="{{url('waec/update')}}">
		{{csrf_field()}}
		...
		@foreach($subjects as $subject)
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="score[]" value="{{$score}}" placeholder="Enter {{$subject->name}} score" />
