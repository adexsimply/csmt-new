...
use App\Assignment_subject as Assignment;
...
{
    private $table = 'assignment_subjects';
    ...
    public function create(Request $request)
    {
        ...
        $subjects = Aagc::find($aagc_id)->subjects;

        return view('domains.assignment_subjects.create',compact('students','aagc_id','session_id','term_id','subjects','category_id'))->render();
    }
    ...
    public function show(Request $request)
    {
        ...
        $attendances = Assignment::join('students','students.id','assignment_subjects.student_id')
                        ->where([
                            ['aagc_id',$aagc_id],
                            ['session_id',$session_id],
                            ['term_id',$term_id],
                        ...
                        ->get(['surname','students.id as student_id','othernames','admission_no','assignment_subjects.status','assignment_subjects.date']);

        $attendances = Addon::isEmpty($attendances);

        return view('domains.assignment_subjects.show',compact('attendances','date','aagc_id','session_id','term_id','subject_id'))->render();
