...
class AttendanceController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('domains.attendances.create',compact('students','aagc_id','session_id','term_id','category_id'))->render();
    }
    ...
    public function show(Request $request)
    {
        ...
        $attendances = Attendance::join('students','students.id','attendances.student_id')
                        ...
                        ->get(['surname','students.id as student_id','othernames','admission_no','attendances.status','attendances.date']);

        $attendances = Addon::isEmpty($attendances);

        return view('domains.attendances.show',compact('attendances','date','aagc_id','session_id','term_id'))->render();
