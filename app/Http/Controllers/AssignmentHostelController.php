...
use App\Assignment_hostel as Assignment;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use App\Aagc;
use App\Plugin\Addon;

class AssignmentHostelController extends Controller
{
    private $table = 'assignment_hostels';
    ...
    public function create(Request $request)
    {
        ...
        return view('domains.assignment_hostels.create',compact('students','aagc_id','session_id','term_id','category_id'))->render();
    }
    ...
    public function show(Request $request)
    {
        ...
        $attendances = Assignment::join('students','students.id','assignment_hostels.student_id')
                        ->where([
                            ['aagc_id',$aagc_id],
                            ['session_id',$session_id],
                            ['term_id',$term_id],
                        ...
                        ->get(['surname','students.id as student_id','othernames','admission_no','assignment_hostels.status','assignment_hostels.date']);

        $attendances = Addon::isEmpty($attendances);

        return view('domains.assignment_hostels.show',compact('attendances','date','aagc_id','session_id','term_id'))->render();
