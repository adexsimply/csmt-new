...
<?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <body>
              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                    <thead>
                      ...
                      <tr style="border-bottom:2px solid black;">
                        ...
                        <th style=" text-align:center" class="blue-st">10</th>
                        <th style=" text-align:center" class="blue-st">10</th>
                        <th style=" text-align:center" class="blue-st">20</th>
                        <th style=" text-align:center" class="blue-st">50</th>
                    ...
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                          ...
                          <td class="blue-subj" style="padding-left:3%;"><?php echo e($score['gp']); ?></td>
                          <td class="blue-subj" style="padding-left:2%;"><strong class="blue-st"><?php echo e($score['grade']); ?></strong></td>
                          <td class="blue-subj"><strong class="blue-st"><?php echo e($score['remark']); ?></strong></td>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr style="height: 50px;">
                <td style="padding-top: 10px">Punctuality</td><td style="padding-top: 10px">Classroom:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student_id))); ?>
              ...
              <tr style="height: 30px;">
                ...
                <?php echo e(App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student_id))); ?></td>
              </tr>
      ...
      <div style="width:66%;font-size:20px;float:left;margin-top:-15px;"> 
        <?php $comments = App\Comment::comments($aagc_id,$session_id,$term_id,$student->student_category_id,$student->id); ?>
         <p>Comment by Form Teacher: <span class="blue-com"><?php if (!empty($comments)) { echo $comments->teacher_comment; } else { echo "No Comment Yet"; } ?></span><br/>
          <?php 
          if ($student->student_category_id ==1) {?>
        Comment by Hostel Parent: <span class="blue-com"><?php if (!empty($comments)) { echo $comments->hostel_comment; } else { echo "No Comment Yet"; } ?></span><br/>
        <?php } ?>
        Comment by Principal: <span class="blue-com"><?php if (!empty($comments)) { echo $comments->principal_comment; } else { echo "No Comment Yet"; } ?></span></p>
