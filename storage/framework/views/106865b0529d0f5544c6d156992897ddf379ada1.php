<div class="col-sm-12">
			<input  name="aagc_id" value="<?php echo e($aagc_id); ?>">
			<input  name="session_id" value="<?php echo e($session_id); ?>">
			<input  name="term_id" value="<?php echo e($term_id); ?>">
			<input  name="subject_id" value="<?php echo e($subject_id); ?>">
	<?php if($attendances): ?>
		
		<form method="post" onsubmit="oisForm(event)" action="<?php echo e(url('assignment/subject/update')); ?>">
