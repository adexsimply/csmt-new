...
window.subject_schoolOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/subject_schools")); ?>',function(data){
			console.log(data);
...
window.subject_categoryOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/subject_categories")); ?>',function(data){
			console.log(data);
...
window.student_postOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/student_posts")); ?>',function(data){
			console.log(data);
...
window.student_categoryOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/student_categories")); ?>',function(data){
			console.log(data);
...
window.student_abilityOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/student_abilities")); ?>',function(data){
			console.log(data);
...
window.stateOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/states")); ?>',function(data){
			console.log(data);
...
window.lgaOptions = function(state_id,x=null){
		...
		$.get('<?php echo e(url("select/lgas")); ?>',{state_id:state_id},function(data){
			console.log(data);
...
window.houseOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/houses")); ?>',function(data){
			console.log(data);
...
window.gradeOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/grades")); ?>',function(data){
			console.log(data);
...
window.clubOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/clubs")); ?>',function(data){
			console.log(data);
...
window.subjectOptions = function(x=null,sql=null){
		...
		var url = sql ==null ? '<?php echo e(url("select/subjects")); ?>' : '<?php echo e(url("select/subjects")); ?>/'+sql;
...
window.classOptions = function(x=null,armList=false){
		...
		$.get('<?php echo e(url("select/classes")); ?>',function(data){
			console.log(data);
...
window.assessment_typeOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/assessment_types")); ?>',function(data){
			console.log(data);
...
window.armOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/arms")); ?>',function(data){
			console.log(data);
...
window.aliasOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/aliases")); ?>',function(data){
			console.log(data);
...
window.groupOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/groups")); ?>',function(data){
			console.log(data);
...
window.session_termOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/session_term")); ?>',function(data){
			console.log(data);
	...
	window.termOptions = function(x=null){
		...
		$.get('<?php echo e(url("select/terms")); ?>',function(data){
			console.log(data);
...
window.sessionOptions = function(x=null,selectMessage=true){
		...
		$.get('<?php echo e(url("select/sessions")); ?>',function(data){
			console.log(data);
