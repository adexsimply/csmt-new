<div class="col-sm-12">
	<?php if($attendances): ?>
		...
		<form method="post" onsubmit="oisForm(event)" action="<?php echo e(url('punctuality/classroom/update')); ?>">
						...
						<tr>
							...
							<td>
								<?php if($student->status == 2): ?>
									<input checked="" type="radio" required class="radio-lg" name="status[<?php echo e($x); ?>]" value="2">
								<?php else: ?>
									<input type="radio" required class="radio-lg" name="status[<?php echo e($x); ?>]" value="0">
								<?php endif; ?>
							</td>
