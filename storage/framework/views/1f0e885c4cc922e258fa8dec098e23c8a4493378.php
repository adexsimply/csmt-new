...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name')); ?> Senior school result</title>
    ...
    <body>
                ...
                <table class="table table-bordered table-condensed" style="margin-top:-18px;">
                  <tbody>
                      <tr>
                        ...
                        <?php echo e(App\Assessment::classCount2($aagc_id,$session_id,$student->student_category_id,3)); ?>
              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                    ...
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                          ...
                          <?php $score = App\Assessment::termStudentScoreCat($student_id,$subject->id,$aagc_id,$session_id,$term_id) ;



                          ?>

                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['test1']) ? $score['scores']['test1'] : '-'); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['test2']) ? $score['scores']['test2'] : '-'); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['test3']) ? $score['scores']['test3'] : '-'); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['micro_exam']) ? $score['scores']['micro_exam'] : '-'); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['exam']) ? $score['scores']['exam'] : '-'); ?></td>
                          <td class="blue-subj" style="padding-left:3%;"><?php echo e(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam']); ?></td>
                          <td class="blue-subj" style="padding-left:2%;"><strong class="blue-st"><?php echo e(App\Assessment::grade(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam'])); ?></strong></td>
                          <td class="blue-subj"><strong class="blue-st"><?php echo e(App\Assessment::remark(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['test3'])/2)+$score['scores']['exam']+$score['scores']['micro_exam'])); ?></strong></td>
      ...
      <div class=""></div>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr>
                <td>Punctuality</td><td>Classroom:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student_id))); ?>

                                         <div><div id="span1" class="t">Resumption:&nbsp;
                                         <?php echo e(strtoupper(App\Assessment::rPunctuality($aagc_id,$session_id,$term_id,$student_id))); ?></div></div></td>
              </tr>
              <tr>
                <td>Attendance</td><td>Classroom:&nbsp;
                <?php echo e(App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student_id))); ?>

               </td>
              </tr>
              <tr>
                <td>Carrying out Assignments</td><td>Classroom:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::sAssigment($aagc_id,$session_id,$term_id,$student_id))); ?><!-- <div><div id="span1" class="t">Hostel:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::hAssigment($aagc_id,$session_id,$term_id,$student_id))); ?>

                                         </div></div> --></td>
              </tr>
              <tr>
                <td>Others</td><td>Clinic:&nbsp; <?php if (App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student_id) >0) { echo App\Assessment::remark2((App\Assessment::clinicCount($aagc_id,$session_id,$term_id,$student_id)*100)/App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student_id)); } else { echo "NOT REGULAR"; } ?><div><div id="span1" class="t">Exeat:&nbsp; <?php if (App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student_id)>0) { echo App\Assessment::remark2((App\Assessment::exeatCount($aagc_id,$session_id,$term_id,$student_id)*100)/App\Assessment::attendanceCount($aagc_id,$session_id,$term_id,$student_id)); } else { echo "NOT REGULAR"; } ?></div></div></td>
              </tr>
          </tbody>
        </table>
