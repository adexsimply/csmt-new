<div style="z-index: 999; margin-top: -25px;" class="pull-right os-dropdown-trigger os-dropdown-position-left">
                        ...
                        <div class="os-dropdown bg-primary">
                          <ul>
                            ...
                            <li>
                              <a onclick="oisNew(event)" data-title="Generate pin" data-type="purple" href="<?php echo e(url('sms/create-pin')); ?>">
                                <i class="fas fa-tint"></i><span> Generate pin</span>
                              </a>
                            </li>

                            <li>
                              <a href="<?php echo e(url('sms/pins')); ?>">
                            ...
                            <li>
                              <a onclick="oisNew(event)" data-title="Send pin" data-type="purple" href="<?php echo e(url('sms/send-pin')); ?>">
