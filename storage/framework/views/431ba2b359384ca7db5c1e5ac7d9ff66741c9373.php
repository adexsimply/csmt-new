<div class="element-box">
						...
						<form action="<?php echo e(url('students/store-switch')); ?>" onsubmit="oisForm(event)" method="post" class="f-16">
							...
							<input type="hidden" name="parent_id" value="<?php echo e($student->parent_id); ?>">

							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="">Student Id</label>
										<input type="text" name="admission_no" value="<?php echo e($student->admission_no); ?>" id="admission_no" class="form-control" placeholder="e.g CSMT/SSS/01/123">
									</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" name="surname" value="<?php echo e($student->surname); ?>" id="surname" class="form-control" placeholder="Surname">
								</div>
								<div class="col-md-6">
									<label for="">Other Names</label>
									<input type="text" name="othernames" value="<?php echo e($student->othernames); ?>" id="othernames" class="form-control" placeholder="Other Names">
								</div>
							</div>
							...
							<div class="row mt-4">
								<div class="col-md-6">
									...
									<input name="dob" id="dob" value="<?php echo e($student->dob); ?>" type="date" class="form-control">
								</div>
								<div class="col-md-6">
							...
							<div class="row mt-4">
								<div class="col-md-8">
									...
									<input type="text" name="health_challenges" value="<?php echo e($student->health_challenges); ?>" id="health_challenges" class="form-control" placeholder="e.g Asthma">
								</div>
								<div class="col-md-4">
									<label>Status</label>
							...
							<div class="row mt-4">
								<div class="col-md-12">
									...
									<textarea name="parent_address" id="address" class="form-control"><?php echo e($student->address); ?></textarea>
								</div>
							</div>
							<div class="row mt-4">
								<div class="col-md-12">
									<label for="">Parent full name</label>
									<input type="text" value="<?php echo e($student->name); ?>" name="parent_name" id="parent_name" class="form-control">
								</div>
							</div>
							...
							<div class="row mt-4">
								<div class="col-md-3 form-group">
									...
									<input name="parent_relationship" value="<?php echo e($student->parent_relationship); ?>" id="parent_relationship" type="text" class="form-control">
								</div>
								<div class="col-md-3 form-group">
									<label for="">Phone Number</label>
									<input name="phone1" id="phone1" value="<?php echo e($student->phone1); ?>" type="text" class="form-control">
								</div>
								<div class="col-md-3 form-group">
									<label for="">Alternate Number</label>
									<input name="phone2" id="phone1" value="<?php echo e($student->phone2); ?>" type="text" class="form-control">
								</div>
								<div class="col-md-3 form-group">
									<label for="">Email</label>
									<input name="email" id="email" value="<?php echo e($student->email); ?>" type="text" class="form-control">
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<button type="submit" class="btn btn-primary btn-md">Switch</button>
