  ...
  <div class="os-tabs-w">
      ...
      <div class="tab-content">
         ...
         <div class="tab-pane" id="others" style="min-height: 200px;">
            <a class="btn btn-info" data-type="purple" data-size="s" data-title="Add Remark For <?php echo e($student->surname.' '.$student->othernames); ?>" onclick="oisNew(event)" href="<?php echo e(url('students/new-remark/'.$student->id)); ?>"><i class="os-icon os-icon-ui-49"></i> Add New</a>
            <hr>
              <div class="tablo-with-chart">
