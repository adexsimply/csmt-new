  ...
  <div class="page" style="padding:25px;">
    ...
    <div class="main">
      <table class="table table-bordered table-condensed" style="margin-top:-10px;">
        <tbody>
            <tr>
              <td><strong>Term:&nbsp;</strong><strong class="blue-st"></strong><?php echo e(App\Term::find($term_id)->name); ?></td>
              <td><strong>Class:&nbsp;</strong><strong class="blue-st"><?php echo App\Aagc::name($aagc_id); ?></strong></td>
              <td><strong>Category:&nbsp;</strong><strong class="blue-st"><?php echo e(App\Student::categoryName($category_id)); ?> </strong></td>
      ...
      <div class="panel panel-info" style="line-height:1;">
        <div class="panel-heading" style="background-color:#6A0691;"><h4 style="margin:0;">
          ...
          ?>
          <?php echo e($subject->name); ?></h4></div>
                     ...
                     <?php if(Addon::isEmpty($assessments)): ?>
                      ...
                      <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                          ...
                          <tr style="border-bottom:1px solid black;">
                            ...
                            <th colspan="6" style=" text-align:center" class="blue-st">Score</th>
                        ...
                        <tr style="border-bottom:2px solid black;">
                          ...
                          <th style=" text-align:center" class="blue-st">Micro<br/>Exam</th>
                            ...
                            <tbody class="input">
                              ...
                              <?php $__currentLoopData = $assessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $assessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php
                                    ...
                                    $gp = App\Assessment::gradeHelper($test1,$test2,$test3,$microexam,$exam);

                                   ?>
                                <tr id="<?php echo e($assessment->id); ?>">
                                  <td><?php echo e($x+1); ?></td>
                                  <td class="blue-subj"><?php echo e($assessment->admission_no); ?></td>
                                  <td width="50%" style="border: 1px solid black;" ><?php echo e($assessment->surname.' '.$assessment->othernames); ?></td>
                                  ...
                                  <td><?php echo e(App\Assessment::grade(round($assessment->gp,2))); ?></td>
                                  <td><?php echo e(App\Assessment::remark(round($assessment->gp,2))); ?></td>
                                </tr>
