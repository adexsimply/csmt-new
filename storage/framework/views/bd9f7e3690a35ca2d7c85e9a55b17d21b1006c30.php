                ...
                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="number" min="-1" value="" max="10" name="test1[]" class="form-control" />
                        </td>
                                    
                        <td> <input type="number" min="-1" value="" max="10" name="test2[]" class="form-control" /></td>
                                    
                        <td> <input type="number" min="-1" value="" max="10" name="test3[]" class="form-control" /></td>
                                    
                        <td> <input type="number" min="-1" value="" max="30" name="micro_exam[]" class="form-control" /></td>
                                    
                        <td> <input type="number" min="-1" value="" max="85" name="exam[]" class="form-control" /> </td>
...
<?php else: ?>
	<h3 class="text-center text-danger"> <i class="fas fa-trash"></i> No student found for assessment</h3>
<?php endif; ?>
