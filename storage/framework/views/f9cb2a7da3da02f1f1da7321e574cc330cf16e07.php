...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit report')): ?>
	<?php if(count($students) > 0 ): ?>
		<form action="<?php echo e(url('assessments/update-many-practical')); ?>" onsubmit="oisForm(event)" method="post" class="f-16">
	                ...
	                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                    <tr>
	                        ...
	                        <td>
	                            ...
	                            <input type="number" min="-1" hidden="" value="<?php echo e($student->test1); ?>" max="10" name="test1[]" class="form-control" />
	                            <input type="number" min="-1" hidden="" value="<?php echo e($student->test2); ?>" max="10" name="test2[]" class="form-control" />
								<input type="number" min="-1" hidden="" value="<?php echo e($student->test3); ?>" max="10" name="test3[]" class="form-control" />
								<input type="number" min="-1" hidden="" value="<?php echo e($student->micro_exam); ?>" max="30" name="micro_exam[]" class="form-control" />
								<input type="number" min="-1" hidden="" value="<?php echo e($student->exam); ?>" max="85" name="exam[]" class="form-control" /> 
	                            <input type="number" min="0" value="<?php echo e($student->practical); ?>" max="30" name="practical[]" class="form-control" />
	                        </td>        
	                    </tr>
