<div class="element-box">
						...
						<form action="<?php echo e(url('students/store')); ?>" onsubmit="oisForm(event)" method="post" class="f-16">
							...
							<input name="admitted_session_id" type="hidden" value="<?php echo e($session_id); ?>" />

							<input name="aagc_id" type="hidden" value="<?php echo e($aagc_id); ?>" />
