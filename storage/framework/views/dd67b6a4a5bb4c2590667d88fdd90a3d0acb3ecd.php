              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                    ...
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                          ...
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e($exam_total); ?></td>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              ...
              <tr style="height: 25px;">
                <td style="padding-top: 10px;padding-bottom: 10px">Carrying out Assignments</td><td style="padding-top: 10px;padding-bottom: 10px">Classroom:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::sAssigment($aagc_id,$session_id,$term_id,$student_id))); ?><!-- <div><div id="span1" class="t">Hostel:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::hAssigment($aagc_id,$session_id,$term_id,$student_id))); ?>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:right;">
          <tbody>
                 <?php
                  ...
                  ?>
              <tr>
                <td>Club&nbsp;Performance</td><td><?php echo e($performance ? App\Assessment::remark($performance->performance) : '-'); ?> (<?php echo e($performance->performance); ?>%)</td>
              </tr>
              <tr>
