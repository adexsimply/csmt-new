    ...
    <body>
          ...
          <div align="right" style="margin-top:-25px;font-size:13px;"><strong class="blue-st"><?php echo e(App\Session::find($session_id)->name); ?></strong><strong>&nbsp;Academic Session</strong></div>
              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">    <thead>
                  ...
                  <div class="panel-footer" style="font-size:13px; margin-top:1px; padding:5px; border:1px solid black;">
                    ...
                    &nbsp;<strong>Result:</strong> <strong class="blue-st">PASS</strong>&nbsp; &nbsp;<?php if(App\Term::find($term_id)->name=='THIRD TERM'): ?><strong>Status: </strong> <strong class="blue-st">
      ...
      <div class=""></div>
        ...
        <table class="table table-bordered table-condensed table-responsive" style="width:49%;float:left;">
          <tbody>
              <tr>
                <td>Punctuality</td><td>Classroom:&nbsp;<?php echo e(App\Assessment::remark(App\Assessment::cPunctuality($aagc_id,$session_id,$term_id,$student->id))); ?>
              ...
              <tr>
                ...
                <?php echo e(App\Assessment::remark(App\Assessment::cAttendance($aagc_id,$session_id,$term_id,$student->id))); ?>
