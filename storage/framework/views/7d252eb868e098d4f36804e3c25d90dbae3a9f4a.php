	            ...
	            <table style="width: 100%;" class="table table-lightborder">
	                ...
	                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                    <tr>
	                        ...
	                        <td> <input type="number" min="-1" value="<?php echo e($student->micro_exam); ?>" max="30" name="micro_exam[]" class="form-control" /> <input type="number" min="-1" value="<?php echo e($student->practical); ?>" hidden="" max="30" name="practical[]" class="form-control" /></td>
