              ...
              <div class="element-box"> 
                              ...
                              <form method="post" onsubmit="oisForm(event)" action="<?php echo e(url('comments/update-many')); ?>">
                               ...
                               <table class="table table-lightborder">
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <tr>
                                    ...
                                    <td><input placeholder="Principal's comment" class="form-control" name="principal_comment[]" type="text" value="<?php echo e($student->principal_comment); ?>" /></td>

                                    <td><input placeholder="Teacher's comment" class="form-control" name="teacher_comment[]" type="text" value="<?php echo e($student->teacher_comment); ?>" /></td>

                                    <td><input placeholder="Hostel parent's comment" class="form-control" name="hostel_comment[]" type="text" value="<?php echo e($student->hostel_comment); ?>" /></td>
