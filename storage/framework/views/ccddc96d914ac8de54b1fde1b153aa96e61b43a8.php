                ...
                <table class="table table-bordered table-condensed" style="margin-top:-18px;">
                  <tbody>
                      <tr>
                        ...
                        <?php echo e(App\Assessment::classCount2($aagc_id,$session_id,$student->student_category_id)); ?>
              ...
              <table class="table table-bordered table-striped table-condensed" style="line-height:1px;border: 1px solid black;" width="100%">
                    ...
                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                          ...
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['micro_exam'])/2)); ?></td>
                          <td style=" text-align:center;border: 1px solid black;"><?php echo e(!is_null($score['scores']['exam']) ? $score['scores']['exam'] : '-'); ?></td>
                          <td class="blue-subj" style="padding-left:3%;"><?php echo e(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['micro_exam'])/2)+$score['scores']['exam']); ?></td>
                          <td class="blue-subj" style="padding-left:2%;"><strong class="blue-st"><?php echo e(App\Assessment::grade(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['micro_exam'])/2)+$score['scores']['exam'])); ?></strong></td>
                          <td class="blue-subj"><strong class="blue-st"><?php echo e(App\Assessment::remark(round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['micro_exam'])/2)+$score['scores']['exam'])); ?></strong></td>

                      </tr>

                      <?php 
                            $total+= round(($score['scores']['test1']+$score['scores']['test2']+$score['scores']['micro_exam'])/2)+$score['scores']['exam'];
                            $x++; 
                      ?>
