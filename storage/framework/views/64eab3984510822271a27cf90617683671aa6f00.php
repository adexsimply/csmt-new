                                  ...
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <div class="panel-body card-body">
                                        <form method="post"  onsubmit="oisForm(event)" action="<?php echo e(url('email/send-to-parent')); ?>">
                                    ...
                                    <div class="tab-pane fade" id="others" role="tabpanel" aria-labelledby="profile-tab">
                                      ...
                                      <div class="card-body">    
                                        <div class="col-sm-12">
                                          <form method="POST" onsubmit="oisForm(event)" action="<?php echo e(url('email/send-pin')); ?>">
                                            <?php echo e(csrf_field()); ?>
